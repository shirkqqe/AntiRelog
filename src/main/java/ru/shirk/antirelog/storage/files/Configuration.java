...
public class Configuration {
    ...
    public Configuration(AntiRelog plugin, String absolutePath) {
        this.config = null;
        this.file = null;
    ...
    public void reload() {
        ...
        if (!this.file.exists()) {
            ...
            AntiRelog.getConfigurationManager().createFile(this.name);
        }
    ...
    public void save() {
        ...
        try {
            ...
            AntiRelog.getInstance().getSLF4JLogger().info("Could not save config to {}", this.file, ex);
        }
    }
