...
public class Utils {
    ...
    public static boolean isConsumeItem(@NonNull Material material) {
        ...
        switch (material) {
            case GOLDEN_APPLE, APPLE, ENDER_PEARL, EGG, GOLDEN_CARROT, CARROT, COOKED_SALMON, COOKED_BEEF, COOKED_CHICKEN,
                 COOKED_COD, COOKED_MUTTON, COOKED_PORKCHOP, COOKED_RABBIT, BAKED_POTATO, POTATO, BEETROOT, BEETROOT_SOUP,
